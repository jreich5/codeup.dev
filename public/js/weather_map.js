...
// ================================== Get Weather Request ================================== //
    ...
    function findWeather (lati, long) {
        ...
        $.get($weatherUrl, {
            ...
            // 
            $location.html("");
            $location.append(data.city.name + " " + "<span class='coordinants'>Latitude: " + data.city.coord.lat + " Longitude: " + data.city.coord.lon +"</span>");
...
function buttonFunctionality () {
    ...
    if (isNaN(sum) == false) {
        ...
        alert("valid input" + $latitude + "/" + $longitude);
